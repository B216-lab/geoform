const ruCommon = {
  ...
  validation: {
    ...
    arrivalAfterDeparture: "Время прибытия должно быть позже времени отправления",
    addAtLeastTwoMovements:
      "Добавьте хотя бы два передвижения, например: дом -> работа и работа -> дом. Если в этот день были короткие городские или пригородные поездки, их тоже нужно указать.",
  },
  errors: {
